/** Every statement Ahead runs against PostgreSQL. Tables: `migration.sql`. */
...
export const SAVE_RECEIPT =
  "UPDATE ahead_client SET sequence=$3, receipt=$4 WHERE client_id=$1 AND owner_id=$2 RETURNING client_id";
export const HEAD = "SELECT head FROM ahead_channel WHERE channel=$1";
/**
