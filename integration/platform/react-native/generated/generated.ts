...
export type MutationName = 'AddEntry'|'Edit';
...
export function AddEntry(args:AddEntryArgs) { const operations:object[] = [];
 ...
 return {name:'AddEntry',version:1,operations}; }
...
export class Mutate { readonly port:MutatePort; constructor(port:MutatePort) { this.port=port; }
 addEntry(args:AddEntryArgs):Promise<number> { return this.port.mutate(AddEntry(args)); }
