...
import { Client, type ClientSyncState, type Connection, type ConnectionOptions, type QuerySpec, type RecordValue, type ServerOptions } from "../../../../packages/client-react-native/index.ts";
export { type ServerOptions, type Connection, type ConnectionOptions } from "../../../../packages/client-react-native/index.ts";
import { schema, liveModels, GeneratedTransaction, Mutate, type LiveModels } from "./generated.ts";
...
export class GeneratedClient {
 ...
 private constructor(client: Client, connection: Connection | undefined) { this.client = client; this.connection = connection; this.models = liveModels(client); this.mutate = new Mutate(client); this.channels = new Channels(client); }
