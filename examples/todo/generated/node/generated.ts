...
export class Mutate { readonly port:WritePort; constructor(port:WritePort) { this.port=port; }
...
export class GeneratedTransaction { readonly transaction:WritePort; readonly models:TxModels; readonly mutate:Mutate; constructor(transaction:WritePort) { this.transaction=transaction; this.models=txModels(transaction); this.mutate=new Mutate(transaction); } }
