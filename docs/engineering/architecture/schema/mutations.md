...
None open. The greedy-decoding risk and the empty-update defect recorded here were resolved by the decisions in section 9 ([#54](https://github.com/zanminwang/ahead/issues/54), [#49](https://github.com/zanminwang/ahead/issues/49)).
